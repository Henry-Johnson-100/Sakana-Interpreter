...
-- isReturnRequired :: SyntaxClusterRule -> Bool
-- isReturnRequired scr = not (null (returnRules scr))

-- atLeastSendsRequired :: SyntaxClusterRule -> [Int]
...
-- controlClusterRule (Control Fin) = SCR (Control Fin) [SBGR Send 3] [] False
