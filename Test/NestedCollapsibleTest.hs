...
tN_takes_one_unnested_NC = standardTimeout 5 $ testCase name assertion where
...
tN_takes_one_unnested_NC_that_ends_in_non_terminal_character = standardTimeout 5 $ testCase name assertion where
...
tN_takes_most_unnested_NC_from_list_containing_two_complete_NCs = standardTimeout 5 $ testCase name assertion where
...
tN_returns_itself_if_called_on_only_unnested_complete_NC = standardTimeout 5 $ testCase name assertion where
...
tN_returns_next_NC_if_called_on_complete_NC_with_nest = standardTimeout 5 $ testCase name assertion where
...
tN_returns_nearest_complete_NC_if_called_on_incomplete_NC = standardTimeout 5 $ testCase name assertion where
...
tN_can_be_called_succesively_to_retrieve_nested_NCs = standardTimeout 5 $ testCase name assertion where
...
tDN_actually_returns_deepest_nest = standardTimeout 5 $ testCase name assertion where
